...
function renderAdminOverview(activeTimers = []) {
  ...
  panel.innerHTML = `<section class="admin-overview-shell" aria-labelledby="admin-overview-title">
    ...
    <section class="admin-overview-modules"><div class="admin-overview-block-head"><div><span class="admin-overview-section-label">Navigation opérationnelle</span><h3>Accès rapides</h3></div><span class="admin-overview-count">Modules actifs</span></div><div class="admin-overview-module-grid"><button type="button" class="admin-overview-module" onclick="switchTab('team', document.getElementById('tab-team'))"><span class="admin-overview-module-icon ocean">↗</span><span><strong>Activité &amp; KPI</strong><small>Entrées et canaux</small></span><b>→</b></button><button type="button" class="admin-overview-module" onclick="switchTab('supervision', document.getElementById('tab-supervision'))"><span class="admin-overview-module-icon clay">◎</span><span><strong>Supervision</strong><small>Qualité et coaching</small></span><b>→</b></button><button type="button" class="admin-overview-module" onclick="switchTab('training', document.getElementById('tab-training'))"><span class="admin-overview-module-icon amber">✦</span><span><strong>Formation</strong><small>Parcours et quiz</small></span><b>→</b></button><button type="button" class="admin-overview-module" onclick="switchTab('documentation', document.getElementById('tab-documentation'))"><span class="admin-overview-module-icon green">▱</span><span><strong>Documentation</strong><small>Procédures validées</small></span><b>→</b></button><button type="button" class="admin-overview-module" onclick="switchTab('admin', document.getElementById('tab-admin'))"><span class="admin-overview-module-icon muted">⚙</span><span><strong>Administration</strong><small>Comptes et exports</small></span><b>→</b></button></div></section>
